...
jdbc:mysql://localhost:3306/Deirdre
...
public class RunDB {
    ...
    public static void main(String[] args) {
        ...
        Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/Deirdre?user=root&password=password" );
        ...
        *
         ...
         * You need to uncomment the line - ir.insert(con);
        *
         *  UNcomment Next 2 lines
         */
